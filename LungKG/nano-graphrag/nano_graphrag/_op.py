...
def chunking_by_seperators(
    ...
    # Use wrapper encoding directly instead of retrieving the underlying tokenizer
...
async def _pack_single_community_describe(
    ...
    # 2. Define templates and fixed cost
...
```"""
    ...
    # 3. Process sub-community reports
    report_describe = ""
    contain_nodes = set()
    contain_edges = set()
    ...
    if need_to_use_sub_communities or force_to_use_sub_communities:
        ...
        # Get sub-community reports and contained nodes/edges
    ...
    # 4. Prepare node and edge data (filter out those already in sub-communities)
    ...
    # Filter nodes/edges already present in sub-communities
    nodes_list_data = [
...
async def _find_most_related_text_unit_from_entities(
    ...
    all_text_units = truncate_list_by_token_size(
        ...
        tokenizer_wrapper=tokenizer_wrapper,  # Pass wrapper
    )
